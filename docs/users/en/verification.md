...
Current Korean offline coverage is 34 cases (`normative=10`); the other fixture categories are unchanged. New Korean live evidence uses runner 18; historical runner receipts do not prove a runner 18 execution. Image coverage is 31 fixtures and 17 mutations.
