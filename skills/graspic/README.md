...
같은 기계를 고른 칸(그림/길/뼈대/허점)으로 원리·흐름을 설명합니다. 그림은 유지되고, 나이는 내려가지 않습니다.

## 사용해야 할 때와 사용하지 말아야 할 때

한 기계가 어떻게 도는지 칸을 골라 설명할 때 씁니다.

디버깅, 구현, 리뷰, 번역, 한 줄 사실 조회, 어린이 말투 설명, `/eli5` 대행에 쓰지 않습니다.
...
설명 전에 조각·유형·칸·언어를 채웁니다. 칸은 그림, 길, 뼈대, 허점입니다. 기본 산출은 게시된 페이지이며 mermaid가 시각 채널입니다. 터미널 스크롤백만으로 설명을 남기지 않습니다.
...
- [계약](../../docs/maintainers/graspic/contract.md)
- [테스트](../../docs/maintainers/graspic/testing.md)
- [릴리스](../../docs/maintainers/graspic/release.md)
