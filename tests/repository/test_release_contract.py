...
class ProductReleaseTests(unittest.TestCase):
    ...
    def test_pre_sdd_review_current_archive_identity(self) -> None:
        ...
        self.assertEqual(product.version, "1.3.0")
        self.assertEqual(product.tag, "pre-sdd-review-v1.3.0")
        self.assertEqual(product.artifact_name, "pre-sdd-review-v1.3.0.zip")
