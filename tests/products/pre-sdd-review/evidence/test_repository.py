...
class RepositoryResolutionTests(unittest.TestCase):
    ...
    def test_loaded_skill_snapshot_has_exact_versions_hashes_and_no_root(self) -> None:
        ...
        self.assertEqual(snapshot.declared_version, "1.2.0")
        self.assertEqual(snapshot.release_version, "1.2.0")
    ...
    def test_loaded_skill_snapshot_rejects_version_mismatch(self) -> None:
        ...
        release.write_text(
            release.read_text(encoding="utf-8").replace('version = "1.2.0"', 'version = "9.9.9"'),
            encoding="utf-8",
        )
